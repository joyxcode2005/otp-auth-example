...
export default function ProfilePage() {
  ...
  const handleUpdate = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch(`${BACKEND_URL}/customer/update`, {
        method: "PATCH",
        credentials: "include",
        headers: {
          "Content-Type": "application/json",
        ...
        body: JSON.stringify({
          ...
          selectedAnimal: profileData.selectedAnimal,
          feedTypes: profileData.feedTypes,
            ...
            {loading ? (
              ...
              <div className="p-4 md:p-6">
                <div className="space-y-5 md:space-y-6">
                  ...
                  {/* Animal & Feed Information Skeleton */}
                  <div className="border-2 border-gray-200 rounded-lg md:rounded-xl p-4 md:p-5">
                    <div className="flex items-center gap-2 mb-4">
                      <div className="w-8 h-8 bg-gray-200 rounded-lg animate-pulse"></div>
                    ...
                    <div className="space-y-4">
                      {[1, 2].map((i) => (
                        <div key={i}>
                          ...
                          <div className={`${i === 2 ? 'h-24' : 'h-10'} bg-gray-100 rounded-lg animate-pulse`}></div>
                        </div>
                      ))}
                    </div>
                  </div>
                      ...
                      <div>
                        ...
                        {isEditing ? (
                          ...
                          <div className="flex flex-wrap gap-2">
                            {profileData.feedTypes.filter(f => f).length > 0 ? (
                              ...
                              <p className="text-gray-800 font-semibold text-sm md:text-base">-</p>
                            )}
                          </div>
                        )}
                      </div>
                    ...
                    {isEditing ? (
                      <>
                        <button
                          ...
                          className="flex-1 bg-gray-200 hover:bg-gray-300 disabled:opacity-50 text-gray-800 font-semibold py-2.5 md:py-3 rounded-xl transition-all text-sm md:text-base"
                          disabled={updating}
                        >
                          Cancel
                        </button>
